...
export const EXTRA_DEPARTMENTS = Object.freeze([
  ...
  { id: "STUDIO_COPYWRITER", parent: "CREATIVE_STUDIO", mission: "Premium advertising copy, hooks, scripts, CTAs and campaign concepts." },
  { id: "STUDIO_ART_DIRECTOR", parent: "CREATIVE_STUDIO", mission: "Visual direction, poster composition, typography, brand consistency and art direction." },
  { id: "STUDIO_VIDEO_PRODUCER", parent: "CREATIVE_STUDIO", mission: "Video ad production plans, scene sequencing, motion direction and render orchestration." },
  { id: "STUDIO_MOTION_EDITOR", parent: "CREATIVE_STUDIO", mission: "Motion graphics, transitions, timing, aspect-ratio variants and final video rendering." },
  { id: "THREAT_INTELLIGENCE", parent: "SECURITY_TRIAD", mission: "External threat intelligence and defensive signal correlation." },
  { id: "IDENTITY_DEFENSE", parent: "SECURITY_TRIAD", mission: "Authentication, authorization, session and privileged-action defense." },
  { id: "PROMPT_GUARDIAN", parent: "SECURITY_TRIAD", mission: "Prompt injection and instruction-conflict defense across AI workflows." },
  { id: "FRAUD_ABUSE", parent: "SECURITY_TRIAD", mission: "Payment, account, automation and abuse detection." },
  { id: "CYBER_SENTINEL", parent: "SECURITY_TRIAD", mission: "Advanced defensive security architecture, intrusion detection and containment." },
  { id: "REDTEAM_GUARDIAN", parent: "SECURITY_TRIAD", mission: "Authorized adversarial simulation and vulnerability discovery against MA.AI.PS-controlled assets only." },
  { id: "EXPLOIT_DEFENDER", parent: "SECURITY_TRIAD", mission: "Deep exploit-pattern analysis, vulnerability validation and defensive remediation." },
  { id: "AI_SHIELD", parent: "SECURITY_TRIAD", mission: "Advanced defense against jailbreaks, prompt injection, model manipulation and malicious tool use." },
  { id: "ZERO_TRUST_COMMAND", parent: "SECURITY_TRIAD", mission: "Zero-trust architecture, privilege boundaries, lateral-movement detection and compromise containment." }
]);
...
export const ALL_AI_DEPARTMENTS = Object.freeze([
  ...
  "PREVENT", "DETECT", "RESPOND", "THREAT_INTELLIGENCE", "IDENTITY_DEFENSE", "PROMPT_GUARDIAN", "FRAUD_ABUSE",
  "CYBER_SENTINEL", "REDTEAM_GUARDIAN", "EXPLOIT_DEFENDER", "AI_SHIELD", "ZERO_TRUST_COMMAND",
  ...ALL_SPECIALIST_DEPARTMENTS.map(d => d.id)
]);

export const AI_NETWORK_SIZE_PER_CHILD = 60;
export const CHILD_PRODUCT_COUNT = 4;
export const ECOSYSTEM_AI_COUNT = AI_NETWORK_SIZE_PER_CHILD * CHILD_PRODUCT_COUNT;
...
const KEYWORDS = new Map([
  ...
  ["AUTOMATION_QA", /test|testing|regression|quality|qa|audit|verify|release validation/i],
  ["CEO_CALL_AGENT", /call me|answer calls|phone calls|call on my behalf|business calls/i],
  ["STUDIO_COPYWRITER", /ad copy|advert copy|headline|hook|cta|campaign script/i],
  ["STUDIO_ART_DIRECTOR", /art direction|poster design|visual direction|typography|composition/i],
  ["STUDIO_VIDEO_PRODUCER", /video production|video ad|commercial video|storyboard|scenes/i],
  ["STUDIO_MOTION_EDITOR", /motion graphics|transitions|animate|animation|video edit|reels/i],
  ...
  ["THREAT_INTELLIGENCE", /threat intelligence|external threat|indicator|ioc|emerging attack/i],
  ["IDENTITY_DEFENSE", /identity|authentication|authorization|session|privileged access/i],
  ["PROMPT_GUARDIAN", /prompt injection|instruction attack|jailbreak|tool abuse/i],
  ["FRAUD_ABUSE", /fraud|abuse|suspicious payment|transaction anomaly|account abuse/i],
  ["CYBER_SENTINEL", /cyber sentinel|intrusion detection|security architecture|containment/i],
  ["REDTEAM_GUARDIAN", /red team|redteam|adversarial simulation|authorized security test/i],
  ["EXPLOIT_DEFENDER", /exploit|vulnerability validation|remediation/i],
  ["AI_SHIELD", /ai shield|model manipulation|jailbreak|prompt injection|malicious tool/i],
  ["ZERO_TRUST_COMMAND", /zero trust|lateral movement|privilege boundary|compromise containment/i]
]);
...
export const DEPARTMENT_COUNTS = Object.freeze({
  council: 10,
  specialists: 24,
  additional: 5,
  studioSubordinates: 4,
  securityArmy: 12,
  eliteSecurity: 5,
  networkPerChild: 60,
  childProducts: 4,
